...
export default function DeliveryRequestCard({navigation}) {
  return (
    <View className="z-10 absolute bottom-0 w-full bg-white p-4 pb-12 rounded-t-3xl">
      <Text className="px-3 font-extrabold text-lg">Delivery Request</Text>
            <View className="pt-2 pl-2 flex-row mt-3 space-x-3">
                ...
                <View className="mt-1  mr-20">
                    <Text className="font-bold ">Ninja Sushi</Text>
      ...
      <View className="pt-2 pl-2 flex-row mt-3 space-x-3">
                ...
                <View className="mt-1  mr-20">
                    <Text className="font-bold ">Shadi</Text>
                    <Text className="font-light text-gray-500">Customer address</Text>
                    <Text>29, Westheim, Somewhere cool</Text>
                </View>
      ...
      <View className="flex-row space-x-3 p-3">
        ...
        <View className="flex-row space-x-2">
            ...
            <TouchableOpacity onPress={()=>{navigation.navigate("DeliveryTracking")}} className="rounded-lg w-36 mt-3 mr-3 bg-indigo-500 p-4 items-center">
                <Text className="font-bold text-white align-middle">Accept</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={()=>{navigation.navigate("DeliveryTracking")}} className="rounded-lg w-36 mt-3 mr-3 bg-white border border-indigo-500 p-4 items-center">
